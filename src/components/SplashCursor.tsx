 ...
 * Adapted from React Bits, styled for Klein Blue (#002FA7) portfolio theme.
 *
 * Usage: <SplashCursor /> renders a fixed full-viewport canvas overlay (pointer-events: none).
 */
