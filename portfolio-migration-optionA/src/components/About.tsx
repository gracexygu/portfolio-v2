      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* Quote - 金句衬线化 */}
            <blockquote className="font-serif italic text-xl text-text my-10 pl-5 border-l-2 border-klein leading-relaxed">
              "{aboutContent.quote}"
            </blockquote>
          ...
          <div className="md:justify-self-end max-w-sm md:max-w-md order-first md:order-last">
            <img 
              src="/photo.jpg" 
              alt="Grace" 
              className="w-full aspect-[4/5] object-cover object-top border border-border-l2 transition-all hover:border-klein hover:scale-[1.01]"
            />
          </div>
        </div>
      </div>
